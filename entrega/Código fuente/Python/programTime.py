...
sql="SELECT P.Hora_ini, P.Hora_fin FROM arduino AS A, arduino_programacion AS AP, programacion AS P WHERE A.IDArduino='"+sArduino+"' AND A.IDArduino=AP.Arduino_IDArduino AND AP.Programacion_IDProg=P.IDProg;"
...
PuertoSerie.close()
#se repite igual para los demas puertos